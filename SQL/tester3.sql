...
SELECT
  ...
  -- Check which columns exist and uncomment/modify accordingly:
  mls.LIST_PRICE,           -- Most common
  mls.CLOSE_PRICE,          -- Alternative: SOLD_PRICE, SALE_PRICE, FINAL_PRICE
  mls.ORIGINAL_LIST_PRICE,  -- Original listing price
  -- mls.CURRENT_PRICE,     -- If available
  -- mls.PREVIOUS_PRICE,    -- If available

  -- TIME-TO-SELL COLUMNS - ADJUST NAMES TO MATCH YOUR SCHEMA
  mls.DAYS_ON_MARKET,       -- Alternative: DOM
  mls.CUMULATIVE_DAYS_ON_MARKET,  -- Alternative: CDOM
  mls.STATUS,               -- Alternative: MLS_STATUS, LISTING_STATUS, PROPERTY_STATUS
  mls.STANDARD_STATUS,      -- If available

  -- DATE COLUMNS (to calculate DOM if not directly available)
  mls.LIST_DATE,            -- When property was listed
  mls.CLOSE_DATE,           -- When property closed/sold
  mls.PENDING_DATE,         -- When went pending
  mls.EXPIRATION_DATE,      -- If available
  mls.OFF_MARKET_DATE,      -- If available
